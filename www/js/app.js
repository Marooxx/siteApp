...
angular.module('OmzApp', [
  'ionic',
  'OmzApp.common.directives',
  'OmzApp.app.services',
  'OmzApp.app.filters',
  'OmzApp.app.controllers',
  'OmzApp.auth.controllers',
  'underscore',
  'angularMoment',
  'ngCordova',
  'monospaced.elastic'
...
.run(function($ionicPlatform) {// Au lancement de l'application , on veut qu'il fasse qch
...
});// c'est la route par défaut donc la state par défaut 
// cela indique où l'index va pointer au départ, au lancement de l'appli
