angular.module('OmzApp.app.services', [])
...
.service('TrendsService', function ($http, $q){
  this.getTrends = function(){
    ...
    $http.get('http://localhost/siteApp/Api/browse.').success(function(database) {
  ...
  this.getTrend = function(trendId){
    ...
    $http.get('http://localhost/siteApp/Api/browse.php').success(function(database) {
